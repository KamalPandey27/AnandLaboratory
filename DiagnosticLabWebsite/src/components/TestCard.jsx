...
function TestCard(props) {
  return (
    <>
      ...
      <div
        className="mt-10 flex flex-col justify-between p-5 border border-gray-400 rounded-md relative transition-all duration-300 hover:scale-105 hover:bg-gradient-to-br hover:from-blue-700 hover:to-gray-300 hover:text-white
...
"
      >
        <div>
          ...
          <p className="font-mono mt-2 text-sm sm:text-base md:text-lg">
            {props.des}
          </p>
        </div>
